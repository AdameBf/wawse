...
<form method="post" action="scheme-edit-check.php" enctype="multipart/form-data">
	...
	<tr>
		...
		<td style="width:250px;"><input type="text" name="sch_short_desc" id="sch_short_desc" value="<?php echo $get_scheme_info_result['sch_short_desc']; ?>" maxlength="255" /></td>
	...
	<tr>
		...
		<td style="padding-left: 25px; width: 80px;"><input type="checkbox" name="sch_comments" id="sch_comments" <?php if ($get_scheme_info_result['sch_allow_comments'] == 1) { echo 'checked="checked"'; } ?> /></td>
