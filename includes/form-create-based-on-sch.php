<h1><?php echo $str['sch_editor_sch_creation_based_on_title'].' '.$get_scheme_info_result['sch_name'].' '.$str['sch_editor_sch_viewer_by'].' '.$get_scheme_info_result['sch_author'].' (#'.$_GET['id'].')'; ?></h1>
...
<tr>
	...
	<p><input type="hidden" name="action" value="create" /><input type="hidden" name="sch_id" value="<?php echo $sch_id; ?>" /><input type="submit" value="<?php echo $str['sch_editor_send']; ?>" /></p>
	</td>
</tr>
</table>
</form>