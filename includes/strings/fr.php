...
$str['sch_editor_rubber_air_viscosity_hint'] = 'Ici, vous pouvez définir la vitesse à laquelle un objet volant perd de la vitesse. Si la valeur est impaire, alors cela s\'applique également aux vers.';
...
$str['sch_editor_changelog_v0_6_0b_item1'] = '[Correction] Lors de la création d\'un scheme, la valeur de l\'option "temps de détonateur des mines" était également sauvegardée comme valeur de l\'octet représentant l\'option "méthode de placement des vers par accident".';
