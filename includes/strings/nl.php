...
$str['sch_editor_turn_time_hint'] = 'Als u wilt dat uw beurt oneindig lanf is, type 128.';
...
$str['sch_editor_object_type_hint'] = 'Zaullen er objecten zijn op uw land? Zo ja, wat voor soor objecten? Mijnen? Olie vaten? Beide?';
...
$str['sch_editor_rubber_circular_aim_hint'] = 'Ja, Deze optie komt vab Test-Stuff, but with Rubber it is stored in the scheme file directly. Requires RubberWorm for 3.6.31.0 or later.';
...
$str['sch_editor_sch_upload_error_invalid_scheme_file'] = 'Ongeldige speel stijl file. The following errors were found:';
...
$str['sch_editor_sch_upload_retreat_time_fix'] = 'The Land Retreat Time byte value has been reset to 127 (was %1)'; // Do not remove any %1 or %2 in this translation file - however, feel free to move them inside the string.
...
$str['sch_editor_sch_viewer_sch_author'] = 'Autheur:';
...
$str['sch_editor_changelog_v1_0_2_item3'] = '[Fixed bug] The \' char is now correctly parsed in Scheme Descriptions.';
