...
<tr>
	...
	<tr>
		...
		<td style="padding-left: 25px; width: 80px;"><input type="checkbox" name="rubber_sdet" id="rubber_sdet" /></td>
	...
	<tr>
		...
		<td style="padding-left: 25px;"><input type="checkbox" name="rubber_ldet" id="rubber_ldet" /></td>
	...
	<tr>
		...
		<td><input type="text" name="rubber_air_resistance" id="rubber_air_resistance" maxlength="3" size="2" value="0" style="font-size: 0.9em;" onchange="checkValue(this, 0, 255, 0, '<?php echo $language; ?>')" /></td>
	</tr>
	<tr>
		<td colspan="2"></td>
