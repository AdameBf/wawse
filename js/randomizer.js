...
// A- Handgun, Prod (slightly more than 1/2 chance to have Infinite of them).
...
// B- Bazooka, Grenade, Shotgun, Uzi, Fire Punch, Dragon Ball (slightly more than 1/3 chance to have Infinite of them).
...
// C- Ninja Rope, Parachute (slightly more than 1/6 chance to have Infinite of them).
...
// D- Bungee (slightly more than 1/8 chance to have Infinite of it).
...
// E- Petrol Bomb, Mortar (values from 0-5 are very probable; there's a little more than a 1/16 chance to have Infinite of them).
...
// F- Longbow, Mine, Blow Torch, Pneumatic Drill (values from 0-3 are very probable; there's a little more than a 1/20 chance to have Infinite of them).
